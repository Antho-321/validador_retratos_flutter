...
class PortraitValidationApi {
  ...
  // NOTE: Segmentation methods (segmentarImagen, obtenerMascara) were removed.
  // All segmentation is now handled server-side by utn-movil-asistente-retratos
  // via the procesar_pipeline_integrado() function.
}
